...
if($op=="del"){
$obj->connessione();
$dati=mysql_query("delete from sottocategorie where id='$idx'");
...
if($op=="ins"){
$obj->connessione();
$dati=mysql_query("insert into sottocategorie(nome,idcat) values('$nome','$idcat')");
//if($dati){echo"inserita";}
//else {echo"non inserita";}
}
?>

<a href="sel_categorie.php">Categorie</a> - Sottocategorie per <strong><?echo $n;?></strong><br>
...
<?
$obj->connessione();
$dati=mysql_query("select * from sottocategorie where idcat='$idcat' order by nome");
...
$id=$array[id];
echo "<tr><td>".$array[id]."</td><td>".$array[nome]."</td><td><a href=\"mod_sottocategorie.php?id=$id&n=$n&idcat=$idcat\"><img border=\"0\" src=\"images/pen16.gif\" alt=\"Modifica\"></a></td><td><a href=\"sel_sottocategorie.php?idx=$id&op=del&n=$n&idcat=$idcat\"><img border=\"0\" src=\"images/delete16.gif\" alt=\"Elimina\"></a>"."</td></tr>";
}
...
<form method="get" action="sel_sottocategorie.php">
Nuova sottocategoria <input type="hidden" value="ins" name="op"> <input type="hidden" value="<?echo $idcat;?>" name="idcat"> <input type="hidden" value="<?echo $n;?>" name="n"> <input type="text" name="nome"> <input type="submit" value="Inserisci">
</form>
