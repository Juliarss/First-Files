...
<center>
<a href="sel_prodotti.php">Prodotti</a> <b>Ins foto per <?echo $n;?></b>
<br>

<?
if($_GET['op']=="del"){
$obj->connessione();
$dati=mysql_query("delete from immagini where id='$id'");
...
if(strlen($foto1)>0){
$dati2=mysql_query("insert into immagini (idp,percorso) values('$idx','$foto1')");
if($dati2) {
...
<table width="630" bordercolor="#FFFFFF" cellpadding="2" style="font-size: 10px; font-family: Verdana; border-size: 1px" width="630">
                <tr>
                        ...
                        <td bgcolor="#0A64C8" style="font-size: 10px; font-family: Verdana; font-weight: bold; color: #FFFFFF">foto</td>
                        <td bgcolor="#0A64C8" style="font-size: 10px; font-family: Verdana; font-weight: bold; color: #FFFFFF" width="16"></td>
                </tr>

<?
$obj->connessione();
$dati=mysql_query("select * from immagini where idp='$idp' order by id ");
...
<br>
<form action="foto_gallery.php?n=<?echo $n;?>&idp=<?echo $idp;?>" method="post" enctype="multipart/form-data">
