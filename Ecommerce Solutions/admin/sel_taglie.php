...
if($op=="del"){
$obj->connessione();
$dati=mysql_query("delete from taglie where id='$idx'");
...
if($op=="ins"){
$obj->connessione();
$dati=mysql_query("insert into taglie(idp,nome) values('$idp','$nome')");
if($dati){echo"inserita";}
else {echo"non inserita ".mysql_error();}
}
?>

<a href="sel_prodotti.php">Prodotti</a> - taglie per <strong><?echo $n;?></strong><br>
<table width="630" bordercolor="#FFFFFF" cellpadding="2" style="font-size: 10px; font-family: Verdana; border-size: 1px" width="630">
                <tr>
                        ...
                        <td bgcolor="#0A64C8" style="font-size: 10px; font-family: Verdana; font-weight: bold; color: #FFFFFF">Nome colore</td>
                        <td bgcolor="#0A64C8" style="font-size: 10px; font-family: Verdana; font-weight: bold; color: #FFFFFF" width="16"></td>
                </tr>

<?
$obj->connessione();
$dati=mysql_query("select * from taglie where idp='$idp'");
...
$id=$array[id];
echo "<tr><td>".$array[id]."</td><td>".$array[nome]."</td><td><a href=\"sel_taglie.php?idx=$id&op=del&n=$n&idp=$idp\"><img border=\"0\" src=\"images/delete16.gif\" alt=\"Elimina\"></a>"."</td></tr>";
}
}else echo "0 coloti";
?>
</table>
...
<form method="get" action="sel_taglie.php">
Nuova taglia <input type="hidden" value="ins" name="op"> <input type="hidden" value="<?echo $idp;?>" name="idp"> <input type="hidden" value="<?echo $n;?>" name="n"> <input type="text" name="nome"> <input type="submit" value="Inserisci">
</form>
