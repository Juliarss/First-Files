...
if($op=="del"){
$obj->connessione();
$dati=mysql_query("delete from colori where id='$idx'");
...
if($op=="ins"){
$obj->connessione();
$dati=mysql_query("insert into colori(idp,nome) values('$idp','$nome')");
if($dati){echo"inserita";}
else {echo"non inserita ".mysql_error();}
}
?>

<a href="sel_prodotti.php">Prodotti</a> - Colori per <strong><?echo $n;?></strong><br>
...
<?
$obj->connessione();
$dati=mysql_query("select * from colori where idp='$idp'");
...
$id=$array[id];
echo "<tr><td>".$array[id]."</td><td>".$array[nome]."</td><td><a href=\"sel_colori.php?idx=$id&op=del&n=$n&idp=$idp\"><img border=\"0\" src=\"images/delete16.gif\" alt=\"Elimina\"></a>"."</td></tr>";
}
}else echo "0 coloti";
?>
</table>
...
<form method="get" action="sel_colori.php">
Nuovo colore <input type="hidden" value="ins" name="op"> <input type="hidden" value="<?echo $idp;?>" name="idp"> <input type="hidden" value="<?echo $n;?>" name="n"> <input type="text" name="nome"> <input type="submit" value="Inserisci">
</form>
