...
var urlBase = "update_configurazione.php";
var formVars = "";
var changing = false;
...
function cambia(actual) {
        if(!changing){
                ...
                if(height < 1)
                        ...
                        actual.innerHTML = "<textarea name=\"textarea\" id=\""+ actual.id +"_field\" style=\"width: "+width+"px; height: 100px;\" onfocus=\"highLight(this);\" onblur=\"noLight(this); return fieldBlur(this,'" + actual.id + "');\">" + actual.innerHTML + "</textarea>";
